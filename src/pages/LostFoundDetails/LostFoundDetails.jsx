...
const LostFoundDetails = () => {
    ...
    const { postType, description, title, image, category, date, location, name, email, _id } = lostFoundItem
    ...
    const handleRecover = e => {
        ...
        const postId = from.postId.value;


        const Recover = {
            location, date, name, email, image, postId
        }
                    ...
                    <div className="modal-box ">
                        ...
                        <form className="card-body" onSubmit={handleRecover}>
                            ...
                            <div className="form-control">
                                ...
                                <input type="text" name="postId" value={_id} className="input input-bordered w-full" required />
